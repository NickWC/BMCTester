...
def doYafuflashUpdateFw(case):
    ...
    output = output + "2. Upgrade BMC using Yafuflash: "
    ret = util.exec_yafuflash_updateFw(case.sysConf, filename)
    if ret[2] !=0:
    ...
    output = output + "3. Get Device ID to see FW version: "
